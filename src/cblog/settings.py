...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstone-db.cd0fbmcazaho.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'capstone-blog-emre1' # please enter your s3 bucket name
